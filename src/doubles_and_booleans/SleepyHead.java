...
public class SleepyHead {
    ...
    public static void main(String[] args) {
        ...
        if (isWeekday1 == JOptionPane.YES_OPTION) {
        	System.out.println("Sleep in");
        }else {
        	System.out.println("Get up lazybones!");
        }
        int isVacation1 = JOptionPane.showConfirmDialog(null, "Are we on vacation?", "Sleepy Head", JOptionPane.YES_NO_OPTION);
        if (isVacation1 == JOptionPane.YES_OPTION) {
        	System.out.println("Sleep in");
        }else {
